...
class All_Env_Specific_Variables:
    ...
    def __init__(self, env, pod_name, dbfs_folder_base_path='/dbfs/FileStore/tables/DaaSWealth_QA/Main/'):
        ...
        az_restrict_cdic_db = 'home,srz/cdic,edaaaazepca00wm00gs0001,cdic'
        ...
        az_restrict_cif_db = 'home,srz/cif,edaaaazepca00wm00gs0001,cif'
        ...
        az_restrict_edw_db = 'home,srz/caedw,edaaaazepca00wm00gs0001,caedw'
        ...
        az_restrict_eoae_db = 'home,srz/eoae,edaaaazepca00wm00gs0001,eoae'
        ...
        az_restrict_odr_db = 'home,srz/odr,edaaaazepca00wm00gs0001,odr'
        ...
        az_restrict_ossbr_db = 'home,srz/ossbr,edaaaazepca00wm00gs0001,ossbr'
        ...
        az_restrict_ptsql_db = 'home,srz/ptsql,edaaaazepca00wm00gs0001,ptsql'
        ...
        az_restrict_sfw_db = 'home,srz/sfw,edaaaazepca00wm00gs0001,sfw'
        ...
        az_restrict_upg_db = 'home,srz/upg,edaaaazepca00wm00gs0001,upg'
        ...
        az_restrict_wca_db = 'home,srz/wca,edaaaazepca00wm00gs0001,wca'
        ...
        az_restrict_wdlob_db = 'home,srz/wdlob,edaaaazepca00wm00gs0001,wdlob'
        ...
        az_restrict_wdorg_db = 'home,srz/wdorg,edaaaazepca00wm00gs0001,wdorg'
        ...
        az_restrict_wdprm_db = 'home,srz/wdprm,edaaaazepca00wm00gs0001,wdprm'
        ...
        az_restrict_wds_db = 'home,srz/wds,edaaaazepca00wm00gs0001,wds'
        ...
        az_restrict_wdsm_db = 'home,srz/wdsm,edaaaazepca00wm00gs0001,wdsm'
        ...
        az_restrict_wfs_db = 'home,srz/wfs,edaaaazepca00wm00gs0001,wfs'
        ...
        az_restrict_wlp_db = 'home,srz/wlp,edaaaazepca00wm00gs0001,wlp'
        ...
        az_restrict_w360_db = 'home,srz/w360,edaaaazepca00wm00gs0001,w360'
        ...
        az_restrict_pbcontrib_db = 'home,cz/cpbdw/rbpsw/pbcontrib_dbo,edaaaazepca00wm00gs0001,unknown'
        ...
        az_restrict_tcz04_db = 'home,curated/bbcmn/out,edaaaazepca00wm00gs0001,unknown'
        ...
        az_restrict_cz_db = 'unknown,UNKNOWN,unknown,unknown'
        ...
        az_synapse_conn = {'dc':{'server':'p3002-eastus2-asql-133.database.windows.net','database':'eda-akora-aaaz-CA00WM00GS0001poolprd','scope':'aaaz-base',
                            ...
                            'ep2':{'server':'p3002-eastus2-asql-133.database.windows.net','database':'eda-akora-aaaz-CA00WM00GS0001poolprd','scope':'aaaz-base',
                                'username':'SP_ADB_AAAZ_CA00WM00GS0001_PRD-AppID','password':'SP_ADB_AAAZ_CA00WM00GS0001_PRD_PWD'}}
        az_restrict_synapse_conn = {'dc':{'server':'p3002-eastus2-asql-133.database.windows.net','database':'eda-akora-aaaz-CA00WM00GS0001poolprd','scope':'aaaz-base',
                                        'username':'SP_ADB_AAAZ_CA00WM00GS0001_PRD-AppID','password':'SP_ADB_AAAZ_CA00WM00GS0001_PRD_PWD'},
                                    'ep1':{'server':'p3002-eastus2-asql-133.database.windows.net','database':'eda-akora-aaaz-CA00WM00GS0001poolprd','scope':'aaaz-base',
                                        'username':'SP_ADB_AAAZ_CA00WM00GS0001_PRD-AppID','password':'SP_ADB_AAAZ_CA00WM00GS0001_PRD_PWD'},
                                    'ep2':{'server':'p3002-eastus2-asql-133.database.windows.net','database':'eda-akora-aaaz-CA00WM00GS0001poolprd','scope':'aaaz-base',
                                        'username':'SP_ADB_AAAZ_CA00WM00GS0001_PRD-AppID','password':'SP_ADB_AAAZ_CA00WM00GS0001_PRD_PWD'}}
        az_rahona_synapse_conn = {}
        dev_synapse_conn = {'dc':{'server':'d3004-eastus2-asql-42.database.windows.net','database':'eda-akora-aawcz-curatedpooldev','scope':'aawcz',
        ...
        az_restrict_cz_base_path = {'dc':'abfss://home@edaaaaze1pca00wm0dwm0001.dfs.core.windows.net/curated/wcz0001/dev_lob',
        ...
        exec(f"self.synapse_conn_dict={env}_synapse_conn")
        exec(f"self.cz_base_path_dict={env}_cz_base_path")

        self.synapse_conn = self.synapse_conn_dict.get(pod_name,'')
        ...
        self.db_names = {'cdic':self.cdic_db, 'cif':self.cif_db, 'edw':self.edw_db, 'eoae':self.eoae_db,
                        'odr':self.odr_db, 'ossbr':self.ossbr_db, 'ptsql':self.ptsql_db, 'sfw':self.sfw_db,'upg':self.upg_db,
                        'wca':self.wca_db, 'wdlob':self.wdlob_db, 'wdorg':self.wdorg_db, 'wdprm':self.wdprm_db,
                        'wds':self.wds_db, 'wdsm':self.wdsm_db, 'wfs':self.wfs_db, 'wlp':self.wlp_db,
                        'w360':self.w360_db, 'pbcontrib':self.pbcontrib_db, 'tcz04':self.tcz04_db, 'cz01':self.cz01_db,
                        'cz01stg':self.cz01stg_db, 'cz02': self.cz02_db, 'cz03':self.cz03_db, 'cz03stg':self.cz03stg_db,
                        'cz04':self.cz04_db, 'cz05':self.cz05_db, 'cz06': self.cz06_db}
        print(f'db_names : {self.db_names}\nsynapse_conn: {self.synapse_conn}\ncz_base_path: {self.cz_base_path}')
    ...
    def common_vars_add_to_config(self, config_file_path):
        ...
        conf = dates_needed.add_aditional_parameters(config_file_path, dbfs_folder_base_path=self.dbfs_folder_base_path, **malcode_dict, synapse_conn=self.synapse_conn, cz_base_path=self.cz_base_path)
...
#     env = 'az'
#     pod_name = 'ep1'
#     config_file_path = '/dbfs/FileStore/tables/DaaSWealth_QA/Main/Config/config_file_kar.yaml'
#     cmn_vars = All_Env_Specific_Variables(env, pod_name)
